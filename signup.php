...
require_once(myClass."_myclass.php");
	...
	$script="SELECT * FROM tbl_logins WHERE fullname='$fullname' OR Username='$username'";
	$query = mysqli_query($con,$script) or die(mysqli_error());
	if (mysqli_num_rows($query)>0)
	 {

		header("Location: registration1.php?notif=error");
	 }
	else
		{
				$script ="INSERT into tbl_logins (datein, Fullname, Username, Password)
		values(
		'$datein',
		'$fullname',
		'$username',
